...
$this->title = 'Permissions for role:'. $role->description;
...
<p>
	<?= GhostHtml::a('Edit', ['update', 'id' => $role->name], ['class' => 'btn btn-sm btn-primary']) ?>
	<?= GhostHtml::a('Create', ['create'], ['class' => 'btn btn-sm btn-success']) ?>
</p>
	...
	<div class="col-sm-4">
		<div class="panel panel-default">
			<div class="panel-heading">
				<strong>
					<span class="glyphicon glyphicon-th"></span> <?= 'Child roles' ?>
				</strong>
			</div>
